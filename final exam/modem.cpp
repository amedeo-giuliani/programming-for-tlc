...
unsigned int Modem::getTxPower() const { return tx_power; }
unsigned int Modem::getBitrate() const { return bitrate; }
bool Modem::getVerbose() const { return verbose; }
unsigned int Modem::getConfigurationsCounter() const { return config_counter; }
